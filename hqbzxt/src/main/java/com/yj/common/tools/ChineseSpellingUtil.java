...
public class ChineseSpellingUtil {  
    ...
    private static ChineseSpellingUtil chineseSpelling = null;  
     ...
     * @return 
     */  
    public static ChineseSpellingUtil getInstance() {  
        if (chineseSpelling == null) {  
            chineseSpelling = new ChineseSpellingUtil();  
        }  
    ...
    private static String getSelling(String chs) {  
        String key, value;  
    ...
    public static String getSpelling(String chinese){
    	return getSelling(chinese);  
    }
     ...
     * @return String 
     */  
    public static  String getSpellingHead(String chs) { 
    	//新方法，用pinyin4.jar包获取
    	String convert = "";
		for (int j = 0; j < chs.length(); j++) {
			char word = chs.charAt(j);
			// 提取汉字的首字母
...
//        // 获取全拼字母  
//        System.out.println(ChineseSpellingUtil.getSpellingHead("琪"));  
//    }
