...
var _5=$(_3).attr("name");
//获取事件
var _blur = $(_3).attr("onblur");
var _keydown = $(_3).attr("onkeydown");
var _keyup = $(_3).attr("onkeyup");
...
if($(_3).hasOwnProperty("onblur")){
	_4.find("input.textbox-text").attr("onblur",_blur);
}
if($(_3).hasOwnProperty("onkeydown")){
	_4.find("input.textbox-text").attr("onkeydown",_blur);
}
if($(_3).hasOwnProperty("onkeyup")){
	_4.find("input.textbox-text").attr("onkeyup",_keyup);
}
...
var _1e= 30;
	//_16.height=="auto"?_19.outerHeight():(tb.height()-_1d("top")-_1d("bottom"));
