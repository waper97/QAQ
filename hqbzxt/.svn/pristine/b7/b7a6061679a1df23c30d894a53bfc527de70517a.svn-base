...
$.fn.pagination.defaults={total:1,pageSize:10,pageNumber:1,pageList:[10,20,30,50,100,500,1000],loading:false,buttons:null,showPageList:true,showPageInfo:true,showRefresh:true,links:10,layout:["list","sep","first","prev","sep","manual","sep","next","last","sep","refresh","info"],onSelectPage:function(_d2,_d3){
},onBeforeRefresh:function(_d4,_d5){
},onRefresh:function(_d6,_d7){
},onChangePageSize:function(_d8){
},beforePageText:"Page",afterPageText:"of {pages}",displayMsg:"当前显示第 {from} 到 {to} 条 共 {total} 条记录",nav:{first:{iconCls:"pagination-first",handler:function(){
...
$.fn.tree.defaults={url:null,method:"get",animate:false,checkbox:false,cascadeCheck:true,onlyLeafCheck:false,lines:false,dnd:false,data:null,queryParams:{},formatter:function(node){
return node.text;
...
$.ajax({type:opts.method,url:opts.url,data:_1cd,dataType:"json",headers: {'Authorization':getTokenData()},success:function(data){
data = data.data;
_1ce(data);
},error:function(){
...
var _href  = opts.href;
if(_href.indexOf("?")>0){
	_href = _href+"&Authorization="+getTokenData();
}
else{
	_href = _href+"?Authorization="+getTokenData();
}
$.ajax({type:opts.method,url:_href,cache:false,data:_279,dataType:"html",success:function(data){
_27a(data);
},error:function(){
...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,interval:200,missingMessage:"必填项不能为空.",invalidMessage:null,tipPosition:"right",deltaX:0,deltaY:0,novalidate:false,editable:true,disabled:false,readonly:false,validateOnCreate:true,validateOnBlur:false,events:{focus:_4c8,blur:_4cc,mouseenter:_4cf,mouseleave:_4d2,click:function(e){
var t=$(e.data.target);
...
},message:"请输入有效的邮件地址."},url:{validator:function(_4f7){
...
},message:"请输入合法的URL地址."},length:{validator:function(_4f8,_4f9){
var len=$.trim(_4f8).length;
return len>=_4f9[0]&&len<=_4f9[1];
},message:"输入值介于 {0} 和 {1}之间."},remote:{validator:function(_4fa,_4fb){
var data={};
data[_4fb[1]]=_4fa;
var _4fc=$.ajax({url:_4fb[0],dataType:"json",data:data,async:false,cache:false,type:"get"}).responseText;
return _4fc=="true";
...
$("<textarea id=\""+_503+"\" class=\"textbox-text\" autocomplete=\"off\"></textarea>").prependTo(tb);
	...
	// xx added on 2018-05-24 for keyevent
	var _blur = $(_501).attr("onblur");
	var _keydown = $(_501).attr("onkeydown");
	var _keyup = $(_501).attr("onkeyup");	
	
	var _xx = "<input id=\""+_503+"\" type=\""+opts.type+"\" class=\"textbox-text\" autocomplete=\"off\" ";
	
	if(_blur!=null && _blur!=undefined){
		_xx += " onblur= \""+_blur+"\"";
	}
	if(_keydown!=null && _keydown!=undefined){
		_xx += " onkeydown= \""+_keydown+"\"";
	}
	if(_keyup!=null && _keyup!=undefined){
		_xx += " onkeyup= \""+_keyup+"\"";
	}
...
var _515=28;
	//opts.height=="auto"?_510.outerHeight():(tb.height()-_514("top")-_514("bottom"));
...
$.ajax({url:opts.url,type:"get",xhr:function(){
...
$.extend(_7fa,{page:opts.pageNumber||1,rows:opts.pageSize});
	...
	$.extend(_7fa,{page:0,rows:0});
}
if(opts.sortName){
$.extend(_7fa,{sortStr:opts.sortName,asc:opts.sortOrder=='asc'?1:0});
}
...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{sharedStyleSheet:false,frozenColumns:undefined,columns:undefined,fitColumns:false,resizeHandle:"right",resizeEdge:5,autoRowHeight:true,toolbar:null,striped:false,method:"get",nowrap:true,idField:null,url:null,data:null,loadMsg:"正在处理中，请稍后......",emptyMsg:"",rownumbers:false,singleSelect:false,ctrlSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:20,pageList:[10,20,30,40,50,100,500,1000],queryParams:{},sortName:null,sortOrder:"asc",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollOnSelect:true,scrollbarSize:18,rownumberWidth:30,editorHeight:24,headerEvents:{mouseover:_6e4(true),mouseout:_6e4(false),click:_6e8,dblclick:_6ed,contextmenu:_6f0},rowEvents:{mouseover:_6f2(true),mouseout:_6f2(false),click:_6f9,dblclick:_703,contextmenu:_707},rowStyler:function(_8a2,_8a3){
},loader:function(_8a4,_8a5,_8a6){
var opts=$(this).datagrid("options");
if(!opts.url){
return false;
}
$.ajax({type:opts.method,url:opts.url,data:_8a4,dataType:"json",headers: {'Authorization':getTokenData()},success:function(data){
	if(data.success){
		data.rows = data.data;
		_8a5(data);
	}
...
$.ajax({type:opts.method,url:opts.url,data:_a12,dataType:"json",headers: {'Authorization':getTokenData()},success:function(data){
data.rows = data.data;
_a13(data);
},error:function(){
...
if(opts.mode=="remote"){
_ab9(qq);
_ab1(_ab6,null,{keyWords:q},true);
}else{
...
return _ae5;
},mode:"local",method:"get",url:null,data:null,queryParams:{},showItemIcon:false,limitToList:false,unselectedValues:[],mappingRows:[],view:_ae0,keyHandler:{up:function(e){
nav(this,"prev");
e.preventDefault();
},down:function(e){
nav(this,"next");
...
$.ajax({type:opts.method,url:opts.url,data:_ae9,dataType:"json",headers: {'Authorization':getTokenData()},success:function(data){
data = data.data;
_aea(data);
},error:function(){
...
if(opts.mode=="remote"){
_b53(qq);
grid.datagrid("load",$.extend({},opts.queryParams,{keyWords:q}));
}else{
...
if(opts.mode=="remote"){
_b7e(qq);
grid.treegrid("load",$.extend({},opts.queryParams,{keyWords:q}));
}else{
if(q){
...
//return (m<10?("0"+m):m)+"/"+(d<10?("0"+d):d)+"/"+y;  // xx edited on 2018-06-11
},parser:function(s){
if(!s){
return new Date();
}
